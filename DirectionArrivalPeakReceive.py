...
import DirectionArrivalPeakReceive_epy_block_0 as epy_block_0  # embedded python block
import numpy as np
import scipy as sc
import sip
import threading
...
class DirectionArrivalPeakReceive(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "DoA Peak Receive", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("DoA Peak Receive")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "DirectionArrivalPeakReceive")
        ...
        self._phase_cal_range = qtgui.Range(-180, 180, 2, 0, 200)
        self._phase_cal_win = qtgui.RangeWidget(self._phase_cal_range, self.set_phase_cal, "Phase Cal", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._phase_cal_win)
        ...
        self.qtgui_number_sink_0.set_title("Steering Angle")
        ...
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.epy_block_0 = epy_block_0.blk(antenna_space=d, center_frequency=freq_center)
        self.blocks_throttle2_0 = blocks.throttle( gr.sizeof_gr_complex*1, samp_rate, True, 0 if "auto" == "auto" else max( int(float(0.1) * samp_rate) if "auto" == "time" else int(0.1), 1) )
        self.blocks_phase_shift_0 = blocks.phase_shift(phase_cal, True)
        ...
        self.connect((self.zeromq_sub_source_0, 0), (self.blocks_phase_shift_0, 0))
    ...
    def set_freq_center(self, freq_center):
        ...
        self.epy_block_0.center_frequency = self.freq_center
    ...
    def set_d(self, d):
        ...
        self.epy_block_0.antenna_space = self.d
    ...
    def get_phase_cal(self):
        return self.phase_cal

    def set_phase_cal(self, phase_cal):
        self.phase_cal = phase_cal
        self.blocks_phase_shift_0.set_shift(self.phase_cal)
...
def main(top_block_cls=DirectionArrivalPeakReceive, options=None):
