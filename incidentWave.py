...
class incidentWave(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Simulate Incident Wave", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Simulate Incident Wave")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "incidentWave")
...
def main(top_block_cls=incidentWave, options=None):
