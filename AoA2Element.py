...
import AoA2Element_epy_block_0 as epy_block_0  # embedded python block
import sip
import threading



class AoA2Element(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "AoA 2 Element", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("AoA 2 Element")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "AoA2Element")
...
def main(top_block_cls=AoA2Element, options=None):
