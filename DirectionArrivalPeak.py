...
class DirectionArrivalPeak(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "DoA Peak", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("DoA Peak")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "DirectionArrivalPeak")
...
def main(top_block_cls=DirectionArrivalPeak, options=None):
